...
public class Elevator extends SubsystemBase {
    ...
    public Elevator(int elevatorMotorID, int encoderID){
        ...
        canCoderConfiguration.MagnetSensor.MagnetOffset = Constants.ElevatorConstants.elevatorAbsoluteEncoderOffset;
        canCoderConfiguration.MagnetSensor.SensorDirection = Constants.ElevatorConstants.elevatorEncoderPositiveDirection;
